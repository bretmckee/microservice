...
func request_Backend_Process_0(ctx context.Context, marshaler runtime.Marshaler, client BackendClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterBackendHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BackendClient) error {
	...
	mux.Handle("POST", pattern_Backend_Process_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Backend_Process_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Backend_Process_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Backend_Process_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "microserver", "backend", "process"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Backend_Process_0 = runtime.ForwardResponseMessage
)
