...
func request_Frontend_Process_0(ctx context.Context, marshaler runtime.Marshaler, client FrontendClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterFrontendHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FrontendClient) error {
	...
	mux.Handle("POST", pattern_Frontend_Process_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Frontend_Process_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Frontend_Process_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Frontend_Process_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "microserver", "process"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Frontend_Process_0 = runtime.ForwardResponseMessage
)
